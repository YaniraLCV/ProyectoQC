...
<form role="form" id="form_login" method="post">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 class="page-header">Mantenimiento de Cargos
                <button type="button" class="btn btn-success btn-lg" style="float: right;" data-toggle="modal" data-target="#myModal">Nuevo cargo</button>&nbsp;</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
